                ...
                def eligible?(order, _options = {})
                    ...
                    when "all"
                        ...
                        if last_payment.blank?
                            ...
                            eligibility_errors << "Payment method #{last_payment_payment_method_type} is not supported" unless payment_methods.any? { |payment_method| payment_method.type == last_payment_payment_method_type }
                        end
                    else
